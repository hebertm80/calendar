	...
	<body>
		...
		<div id="show-post" class="content scaffold-show" role="main">
			...
			<ol class="property-list post">
				...
				<li class="fieldcontain">
					<span id="postDate-label" class="property-label"><g:message code="post.postDate.label" default="Post Date" /></span>
					
						<span class="property-value" aria-labelledby="postDate-label"><g:formatDate date="${postInstance?.postDate}" /></span>
